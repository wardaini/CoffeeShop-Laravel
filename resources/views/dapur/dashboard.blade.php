...
@section('content')
<div class="wrap">
    <h1 style="font-family:'Playfair Display',serif; color:var(--cream); margin-bottom:1.5rem;">🍳 Dashboard Dapur</h1>
    ...
    <div class="item-card">
        ...
        <form method="POST" action="{{ route('dapur.update-status', $item) }}" style="margin-top:.8rem;">
            @csrf
